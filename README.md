...
This project uses [Docker](https://www.docker.com) w/ docker-compose-v2, and [Just](https://github.com/casey/just) for easy administration.
...
If you're on MacOS, Docker is available from their website, and Just is available through MacPorts.

To install these requirements on Ubuntu Linux:
- Open a Terminal window.
- Update local cache: `sudo apt-get update`
- Download dependencies: `sudo apt-get install -y docker.io docker-compose-v2`
...
4. Create the initial database with `just initdb`
5. Run the application with `just up`
