...
CREATE TABLE resource_locations (
    ...
    coordinates         POINT         NOT NULL SRID 4326,  -- WGS84; powers ST_Distance_Sphere()
    is_primary          TINYINT(1)    NOT NULL DEFAULT 1,
    is_virtual          TINYINT(1)    NOT NULL DEFAULT 0,
    service_area_notes  TEXT          NULL,
    created_at          DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    SPATIAL INDEX idx_locations_coords (coordinates),      -- NOT NULL required for spatial index
...
CREATE TABLE resource_hours (
    ...
    by_appointment_only TINYINT(1)   NOT NULL DEFAULT 0,
